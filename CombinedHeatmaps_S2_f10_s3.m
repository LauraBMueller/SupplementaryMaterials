%% RMS Heatmaps for Subject 2, 10% MVC, dip condition
...
forceLevel = 10; % adjust to condition
condition = 'dip BGL'; % adjust to condition
RmsSubject = 'Subject 2'; % adjust to trial
...
colorbar;
clim([minValue-100 maxValue-100]); % Apply common color axis limits
