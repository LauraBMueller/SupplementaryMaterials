...
interpolatedDataGrid2 = interpolateBadChannelsV3(data(1:64), ElChannelMapGrid1, badChannelsGrid1);
...
data = rms_f10_peak(65:128);
ElChannelMap = ElChannelMapGrid2;
gridRows = 13;
gridCols = 5;
gridData = mapDataToGrid(data, ElChannelMap, gridRows, gridCols);
disp(gridData)
...
interpolatedDataGrid2 = interpolateBadChannelsV3(data(1:64), ElChannelMapGrid2, badChannelsGrid2);
disp(interpolatedDataGrid2)

% Create Heatmap for Grid 1
ElChannelMap = ElChannelMapGrid2;
rms = gridData(1:64);
badChan = badChannelsGrid2;
plotFlag = 1;
